...
int main(int argc, char* argv[]) {
  ...
  {0.2221524864435196, -0.885042130947113, true},
  {3.133425235748291, 0.39564722776412964, true},
  {1.1064804792404175, 0.46933111548423767, true},
  {0.7875912189483643, 0.3492070436477661, false},
};
